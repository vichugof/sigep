<?php
// $route['home'] = 'Public_Space/get_eptrabajo_layers';
$route['default_controller'] = 'Public_Space'; 
...
$route['geo/passtoep'] = 'Public_Space/pass_to_new_ep';
...
$route['geo/inicio'] = 'Public_Space/inicio';